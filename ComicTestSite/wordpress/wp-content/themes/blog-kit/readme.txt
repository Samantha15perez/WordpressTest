...
Blog Kit is a simple, clean and lightweight blog theme compatible with elementor page builder. It is speed optimized theme with 95% GTMetrix PageSpeed Score.
...
Blog Kit WordPress Theme, Copyright (C) 2018, WP Capsules
Blog Kit is distributed under the terms of the GNU GPL

== Changelog ==

= 1.0.4 - December 05 2018 =
* Instagram Feed Plugin added as recommened plugin
* Link to Pro theme changed

= 1.0.3 - October 09 2018 =
* Elementor version demo added
* Recommended plugin added

= 1.0.2 - October 01 2018 =
* Escape and translation issue fixed 
* Recommended plugin changed
* Minor CSS fix for contact form

= 1.0.1 - September 28 2018 =
* Upsell link added
* Theme info page added
* Blog and single post options added
...
- https://pixabay.com/en/hands-love-people-heart-jeans-1283076/