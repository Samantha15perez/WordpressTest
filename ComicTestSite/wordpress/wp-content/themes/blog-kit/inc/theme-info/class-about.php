		...
		public function free_pro() {
		    ...
		    if ( ! empty( $free_pro ) ) {
		        ...
		        if ( ! empty( $free_pro ) && is_array( $free_pro ) ) {
		            ...
		            echo '<td></td>';
		            echo '<td colspan="2"><a href="https://wptroop.com/item/blog-kit-pro-multi-purpose-blog-theme/" target="_blank" class="button button-primary button-hero">Blog Kit Pro</a></td>';
		            echo '</tr>';
